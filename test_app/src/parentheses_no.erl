...
numbers() ->
    ...
    Bits =
        bnot 2#001 band 2#010 bor 2#100 bxor 2#101 bsl 2#110 bsr 2#111 band (2#100 bxor 2#101),
    Number + Modulo - Bits.

booleans(A, B) when not B, A; A xor B -> bleh;
booleans(A, B) when not B and A or (A xor B) -> blip;
booleans(A, B) ->
...
others(Something) ->
    C =
    case C_ = (catch <<Something:1/big-integer-unit:3>>) of
        _ -> C_
    end,
